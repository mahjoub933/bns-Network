...
import { borrowReturnApproveBook } from '../fn/book/borrow-return-approve-book';
import { BorrowReturnApproveBook$Params } from '../fn/book/borrow-return-approve-book';
import { borrowReturnBook } from '../fn/book/borrow-return-book';
import { BorrowReturnBook$Params } from '../fn/book/borrow-return-book';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `borrowReturnBook()` */
  static readonly BorrowReturnBookPath = '/books/borrow/return/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `borrowReturnBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  borrowReturnBook$Response(params: BorrowReturnBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return borrowReturnBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `borrowReturnBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  borrowReturnBook(params: BorrowReturnBook$Params, context?: HttpContext): Observable<number> {
    return this.borrowReturnBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }

  /** Path part for operation `borrowReturnApproveBook()` */
  static readonly BorrowReturnApproveBookPath = '/books/borrow/return/approve/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `borrowReturnApproveBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  borrowReturnApproveBook$Response(params: BorrowReturnApproveBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return borrowReturnApproveBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `borrowReturnApproveBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  borrowReturnApproveBook(params: BorrowReturnApproveBook$Params, context?: HttpContext): Observable<number> {
    return this.borrowReturnApproveBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
